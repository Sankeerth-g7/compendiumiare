...
const DeleteArticle = () => {
    ...
    const delPost=async(x)=>{
        await axios.delete("https://compendiumiare.onrender.com/api/posts/"+x);
        // console.log(" post deleted ",res);
        await axios.delete("https://compendiumiare.onrender.com/api/postid/"+x);
        alert("post deleted");
        // this.render();
    ...
    useEffect(()=>{
        const fetids=async()=>{
        const res= await axios.get("https://compendiumiare.onrender.com/api/postid");
